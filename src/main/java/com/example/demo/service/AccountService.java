...
public class AccountService {
    ...
    public List<String> getAccountDate(String first_date, String second_date){
        return accountDao.getAccountBetweenDate(first_date,second_date);
    }

    public List<Account> getBalanceByPassbook(String passbook_id){
        return accountDao.getBalanceByPassbook(passbook_id);
    }

    public List<Account> getAccuntByType() {
